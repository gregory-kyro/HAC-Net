...
'''Version without an additional Gaussian filter in the voxelization step-- shown to improve results. Maybe rethink their GaussianFilter class as well?'''
def create_voxelized_hdf (input_train_hdf_path, input_val_hdf_path, input_test_hdf_path, output_train_hdf_path, output_val_hdf_path, output_test_hdf_path, voxels_per_dim=48, box_dim_angstroms=48):
    """
    input:
    ...
    output:
    1) Creates 3 hdf files containing voxelized training, validation, and testing data
    """
